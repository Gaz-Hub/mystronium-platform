...
export const checkEnvironmentVariables = () => {
  ...
  console.log(
    ...
    import.meta.env.VITE_STRIPE_SECRET_KEY ? "✅ SET" : "❌ MISSING",
  );
  console.log(
    "VITE_STRIPE_WEBHOOK_SECRET:",
    import.meta.env.VITE_STRIPE_WEBHOOK_SECRET ? "✅ SET" : "❌ MISSING",
  );
  ...
  console.log(
    "VITE_ADMIN_SECRET:",
    import.meta.env.VITE_ADMIN_SECRET ? "✅ SET" : "❌ MISSING",
  );
  ...
  console.log(
    "VITE_DATA_CONNECT_PROJECT_ID:",
    import.meta.env.VITE_DATA_CONNECT_PROJECT_ID ? "✅ SET" : "❌ MISSING",
  );
  console.log(
    "VITE_DATA_CONNECT_REGION:",
    import.meta.env.VITE_DATA_CONNECT_REGION ? "✅ SET" : "❌ MISSING",
  );
  console.log(
    "VITE_DATA_CONNECT_INSTANCE_NAME:",
    import.meta.env.VITE_DATA_CONNECT_INSTANCE_NAME ? "✅ SET" : "❌ MISSING",
  );
  console.log(
    "VITE_DATA_CONNECT_DATABASE_NAME:",
    import.meta.env.VITE_DATA_CONNECT_DATABASE_NAME ? "✅ SET" : "❌ MISSING",
  );
  console.log(
    "VITE_DATA_CONNECT_USER:",
    import.meta.env.VITE_DATA_CONNECT_USER ? "✅ SET" : "❌ MISSING",
  );
  console.log(
    "VITE_DATA_CONNECT_PASSWORD:",
    import.meta.env.VITE_DATA_CONNECT_PASSWORD ? "✅ SET" : "❌ MISSING",
  );
  console.log(
    "VITE_DATA_CONNECT_CONNECTION_NAME:",
    import.meta.env.VITE_DATA_CONNECT_CONNECTION_NAME ? "✅ SET" : "❌ MISSING",
  );
