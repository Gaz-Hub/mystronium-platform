        ...
        <div className="bg-gray-800/50 backdrop-blur-sm p-8 rounded-xl border border-gray-600 space-y-8">
          <section>
            ...
            <div className="text-gray-300 space-y-4">
              <p>
                By accessing and using MYSTRONIUM™ Platform ("the Service"),
                you accept and agree to be bound by the terms and provision of
                this agreement. If you do not agree to abide by the above,
                please do not use this service.
              </p>
              <p>
                MYSTRONIUM™ is an AI-powered creative platform that provides
                tools for book writing (Ghostscribe), image generation (Vault
                Engine), voice synthesis (Narrata), lore building (Codex Forge),
                and comic creation.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="text-gray-300 space-y-4">
              <p>MYSTRONIUM™ offers multiple subscription tiers:</p>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>
                  <strong>Free:</strong> Limited access with daily credit limits
                </li>
                <li>
                  <strong>Premium (£9.99/month):</strong> Unlimited access to
                  all AI tools
                </li>
                <li>
                  <strong>Creator Pro (£19.99/month):</strong> Premium features
                  plus commercial usage rights
                </li>
              </ul>
              <p>Billing terms:</p>
              <ul className="list-disc list-inside space-y-2 ml-4">
          ...
          <section>
            ...
            <div className="text-gray-300 space-y-4">
              <p>
                ...
                content you create using MYSTRONIUM tools, including:
              </p>
              <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <p>
                <strong>Platform License:</strong> By using the Service, you
                grant MYSTRONIUM™ a limited license to store, display, and
          ...
          <section>
            ...
            <div className="text-gray-300 space-y-4">
              ...
              <p>Book submission requirements:</p>
              <ul className="list-disc list-inside space-y-2 ml-4">
          ...
          <section>
            ...
            <div className="text-gray-300 space-y-4">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li>
                  Generate deepfakes or misleading content about real people
                </li>
                ...
                <li>
                  Use the Service for any automated or bulk operations without
                  permission
                </li>
              </ul>
            </div>
          ...
          <section>
            ...
            <div className="text-gray-300 space-y-4">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li>
                  Service availability may be affected by third-party API
                  limitations
                </li>
                <li>
                  We do not guarantee the quality or suitability of generated
                  content
                </li>
                <li>
                  Users are responsible for reviewing and editing AI-generated
                  content
                </li>
              </ul>
            </div>
          ...
          <section>
            ...
            <div className="text-gray-300 space-y-4">
              <p>
                ...
                by our Privacy Policy, which includes:
              </p>
              <ul className="list-disc list-inside space-y-2 ml-4">
          ...
          <section>
            ...
            <div className="text-gray-300 space-y-4">
              <p>MYSTRONIUM™ shall not be liable for:</p>
              <ul className="list-disc list-inside space-y-2 ml-4">
          ...
          <section>
            ...
            <div className="text-gray-300 space-y-4">
              ...
              <p>
                Upon termination, you will lose access to the Service, but you
            ...
            <div className="text-gray-300 space-y-4">
              ...
              <div className="bg-gray-700/50 p-4 rounded-lg">
                <p>
                  <strong>Email:</strong>{" "}
                  <a
                    href="mailto:legal@mystronium.com"
                    className="text-blue-400 hover:underline"
                  >
                    legal@mystronium.com
                  </a>
                </p>
                <p>
                  <strong>Support:</strong>{" "}
                  <a
                    href="mailto:support@mystronium.com"
                    className="text-blue-400 hover:underline"
                  >
                ...
                <p>
                  <strong>Business:</strong> MYSTRONIUM™ Platform
                </p>
              </div>
            </div>
          </section>
          ...
          <div className="bg-blue-600/20 p-4 rounded-lg border border-blue-500/30">
            <p className="text-blue-300 text-sm">
              <strong>Note:</strong> These terms are effective as of January
              2025. By using MYSTRONIUM™, you acknowledge that you have read,
