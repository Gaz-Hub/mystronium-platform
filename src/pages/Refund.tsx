          ...
          <div className="bg-gray-800/50 backdrop-blur-sm p-8 rounded-xl border border-gray-600 space-y-8">
            <section>
              ...
              <div className="text-gray-300 space-y-4">
                <p>
                  All MYSTRONIUM™ AI plans and digital products are generally non-refundable unless legally required or in specific circumstances outlined below.
                </p>
                <div className="bg-yellow-900/20 border border-yellow-500/50 p-4 rounded-lg">
                  <p className="text-yellow-300">
                    <strong>Important:</strong> Due to the nature of AI-generated content and digital products, most sales are final upon delivery.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="text-gray-300 space-y-4">
                <ul className="list-disc list-inside space-y-2 ml-4">
                  <li>Users can cancel subscriptions at any time before the next billing cycle</li>
            ...
            <section>
              ...
              <div className="text-gray-300 space-y-4">
                ...
                <ul className="list-disc list-inside space-y-2 ml-4">
                  ...
                  <li>Technical issues preventing access to paid features for more than 48 hours</li>
            ...
            <section>
              <h2 className="text-2xl font-bold text-white mb-4">Marketplace Purchases</h2>
              <div className="text-gray-300 space-y-4">
                <p>For books and digital content purchased through our marketplace:</p>
                <ul className="list-disc list-inside space-y-2 ml-4">
                  <li>All sales are final once the digital product is delivered</li>
                  <li>Refunds only for technical delivery failures</li>
                  <li>Content disputes should be reported within 24 hours</li>
                  <li>Creators set their own refund policies for their content</li>
                </ul>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="text-gray-300 space-y-4">
                ...
                <div className="bg-gray-700/50 p-4 rounded-lg mt-6">
                  ...
                  <p>Email: <a href="mailto:billing@mystronium.com" className="text-blue-400 hover:underline">billing@mystronium.com</a></p>
            ...
            <div className="bg-blue-600/20 p-4 rounded-lg border border-blue-500/30">
              <p className="text-blue-300 text-sm">
                <strong>Questions?</strong> Our support team is here to help with any billing or refund questions. We aim to resolve all issues fairly and promptly.
              </p>
            </div>
          </div>
        </motion.div>
