                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div className="bg-gray-700/50 p-4 rounded-lg">
                    <div className="flex items-center space-x-2 mb-2">
                      ...
                      <span className="text-white font-medium">Login Streak</span>
                    </div>
                    <p className="text-blue-400 font-bold">{userProfile.loginStreak} days</p>
                  </div>

                  <div className="bg-gray-700/50 p-4 rounded-lg">
                    <div className="flex items-center space-x-2 mb-2">
                      <CreditCard className="w-5 h-5 text-cyan-400" />
                      <span className="text-white font-medium">Vault Credits</span>
                    </div>
                    <p className="text-cyan-400 font-bold">
                      {userProfile.subscription === 'free' ? userProfile.vaultCredits : '∞'}
                    </p>
                  </div>
                  ...
                  <div className="bg-gray-700/50 p-4 rounded-lg">
                    <div className="flex items-center space-x-2 mb-2">
                      ...
                      <span className="text-white font-medium">Books Created</span>
                    </div>
                    <p className="text-purple-400 font-bold">{userProfile.books.length}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="bg-gray-800/50 backdrop-blur-sm p-6 rounded-xl border border-gray-600">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="text-white capitalize">{userProfile.subscription.replace('-', ' ')}</span>
                  </div>
                  
                  {userProfile.subscription === 'free' && (
                    <div className="flex justify-between">
                      <span className="text-gray-400">Credits:</span>
                      <span className="text-white">{userProfile.vaultCredits}</span>
                    </div>
                  )}
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-white">
                      {userProfile.subscription === 'free' ? 'Mistral Only' : 'GPT-4o + Mistral'}
                    </span>
                  </div>
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-white">
                      {userProfile.subscription === 'free' ? '3/day' : 'Unlimited'}
                    </span>
                  </div>
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-white">
                      {userProfile.subscription === 'free' ? 'Basic' : 'Premium'}
                    </span>
                  </div>
                </div>
              ...
              <div className="bg-gray-800/50 backdrop-blur-sm p-6 rounded-xl border border-gray-600">
                ...
                <div className="space-y-3">
                  {userProfile.books.length === 0 && userProfile.artworks.length === 0 ? (
                    ...
                    <>
                      ...
                      {userProfile.artworks.slice(0, 3).map((artwork, index) => (
                        <div key={index} className="flex items-center space-x-3 p-2 bg-gray-700/30 rounded">
                          <div className="w-2 h-2 bg-cyan-400 rounded-full"></div>
                          <span className="text-white text-sm">{artwork}</span>
                        </div>
                      ))}
                    </>
                  )}
