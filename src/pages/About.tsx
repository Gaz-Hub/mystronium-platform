        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              The ultimate AI-powered platform that helps creators go from
              nothing → book → cartoon. Built for visionaries, dreamers, and
              future mythmakers.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 mb-16">
            <div className="bg-gray-800/50 backdrop-blur-sm p-8 rounded-xl border border-gray-600">
              ...
              <p className="text-gray-300 leading-relaxed mb-4">
                MYSTRONIUM™ democratizes creative content creation by putting
                the power of advanced AI directly into the hands of
                storytellers, artists, and creators worldwide.
              </p>
              <p className="text-gray-300 leading-relaxed">
                We believe that everyone has stories to tell, worlds to build,
                and characters to bring to life. Our platform removes the
                technical barriers and empowers pure creativity.
              </p>
            </div>
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm p-8 rounded-xl border border-gray-600">
              ...
              <p className="text-gray-300 leading-relaxed mb-4">
                To create a world where anyone can transform their imagination
                into professional-quality books, artwork, and multimedia content
                using the power of AI.
              </p>
              <p className="text-gray-300 leading-relaxed">
                We're building the future of creative expression, where
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-400 text-sm">
                  From writing to art to voice - everything you need in one
                  integrated platform
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-400 text-sm">
                  Built by creators, for creators. We understand the creative
                  process
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-400 text-sm">
                  Latest AI models including GPT-4o, SDXL, and ElevenLabs for
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300">
                    AI-powered book writing engine that helps you craft
                    compelling narratives, develop characters, and build entire
                    worlds.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300">
                    Generate stunning visual art, book covers, character
                    designs, and scene illustrations with state-of-the-art AI.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300">
                    Transform your written content into professional voice
                    narrations with customizable AI voices.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300">
                    Build comprehensive lore, track character development, and
                    organize your creative universe.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="text-center bg-gradient-to-r from-purple-600/20 to-pink-600/20 p-8 rounded-xl border border-purple-500/30">
            ...
            <p className="text-gray-300 mb-6">
              Thousands of creators are already using MYSTRONIUM™ to bring
              their stories to life. What will you create?
            </p>
