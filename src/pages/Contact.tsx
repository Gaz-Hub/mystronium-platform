              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:business@mystronium.com"
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm p-6 rounded-xl border border-gray-600">
              ...
              <div className="space-y-3">
                ...
                <div className="bg-green-600/20 p-3 rounded-lg">
                  ...
                  <p className="text-gray-300 text-sm">
                    Manage subscriptions in your profile
                  </p>
                </div>
                ...
                <div className="bg-purple-600/20 p-3 rounded-lg">
                  ...
                  <p className="text-gray-300 text-sm">
                    Visit the Creator Backend for tools
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  Visit the Store page or your Profile to manage subscriptions
                  and upgrade plans.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  Premium and Creator Pro users have commercial usage rights.
              ...
              <div>
                <h3 className="text-white font-medium mb-2">
                  How do I publish a book in the store?
                </h3>
                <p className="text-gray-400 text-sm">
                  Use the Creator Backend to submit your book for review.
                  Approved books appear in the Bookstore.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  We use GPT-4o, Mistral, SDXL, and ElevenLabs for different
                  creative tools.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  Creators earn 80% of book sales revenue. MYSTRONIUM keeps 20%
                  as a platform fee.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  Yes, your content is encrypted and stored securely. You retain
