        ...
        >
          <div className="bg-gray-800/50 backdrop-blur-sm p-8 rounded-xl border border-gray-600">
            ...
            <p className="text-gray-300 text-lg mb-8 max-w-2xl mx-auto">
              ...
              push notifications, offline writing, and exclusive mobile
              features.
            </p>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              ...
              <div className="bg-gray-700/50 p-6 rounded-lg">
                ...
                <p className="text-gray-400 text-sm">
                  Write and create without internet connection
                </p>
              </div>
              ...
              <div className="bg-gray-700/50 p-6 rounded-lg">
                ...
                <p className="text-gray-400 text-sm">
                  Daily writing reminders and inspiration
                </p>
              </div>
              ...
              <div className="bg-gray-700/50 p-6 rounded-lg">
                ...
                <p className="text-gray-400 text-sm">
                  Voice memos, photo inspiration, quick notes
                </p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-6">
              <div className="bg-gray-700/50 p-4 rounded-lg">
                ...
                <p className="text-gray-400 text-sm mb-3">
                  Native iOS app with Apple Pencil support, Shortcuts
              ...
              <div className="bg-gray-700/50 p-4 rounded-lg">
                ...
                <p className="text-gray-400 text-sm mb-3">
                  Material Design 3, Google Assistant integration, and adaptive
                  icons
                </p>
            ...
            <div className="bg-purple-600/20 p-4 rounded-lg border border-purple-500/30 mb-6">
              <p className="text-purple-300 font-medium">
                📲 Pre-register now to get early access and exclusive
                mobile-only collectibles!
              </p>
              <p className="text-purple-200 text-sm mt-2">
                First 1,000 users get a legendary "Mobile Pioneer" badge and
