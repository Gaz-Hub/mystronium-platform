  ...
  const steps = [
    {
      ...
      description:
        "Use our AI-powered writing engine to generate compelling chapters, develop characters, and craft your story.",
    ...
    },
    {
      ...
      description:
        "Generate stunning book covers, character art, and scene illustrations with Vault Engine's AI image generation.",
    ...
    },
    {
      ...
      description:
        "Transform your text into professional voice narrations using Narrata's advanced AI voice synthesis.",
    ...
    },
    {
      ...
      description:
        "Use Codex Forge to organize lore, track characters, and build comprehensive world documentation.",
    ...
    },
    {
      ...
      title: "Publish & Earn",
      description:
        "List your completed works in the MYSTRONIUM Bookstore and start earning from your creativity.",
        ...
        >
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold text-white mb-4">
              How MYSTRONIUM™ Works
            </h1>
            <p className="text-gray-400 text-lg max-w-3xl mx-auto">
              From initial idea to published masterpiece - here's how our
              AI-powered platform transforms your creativity into professional
              content.
            </p>
          </div>
            ...
            {steps.map((step, index) => (
              ...
              >
                <div className="flex-1 bg-gray-800/50 backdrop-blur-sm p-8 rounded-xl border border-gray-600">
                  ...
                  >
                    Try{" "}
                    {step.title.split(" ")[step.title.split(" ").length - 1]}
          ...
          >
            <h2 className="text-2xl font-bold text-white mb-6 text-center">
              Example: Creating "The Dragon's Quest"
            </h2>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-gray-700/50 p-4 rounded-lg">
                ...
                <p className="text-gray-300 text-sm">
                  "Write a fantasy chapter about a young mage discovering an
                  ancient dragon's lair..." → Generated 2,000-word compelling
                  chapter
                </p>
              </div>
          ...
          >
            ...
            <p className="text-gray-300 mb-6">
              Join thousands of creators who are already using MYSTRONIUM™ to
