        ...
        <div className="bg-gray-800/50 backdrop-blur-sm p-8 rounded-xl border border-gray-600 space-y-8">
          <section>
            ...
            <div className="text-gray-300 space-y-4">
              <p>
                At MYSTRONIUM™, we collect information to provide you with the
                best AI-powered creative tools. The information we collect
                includes:
              </p>
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li>
                  ...
                  tools (Ghostscribe, Vault Engine, Narrata, Codex Forge)
                </li>
                <li>
                  <strong>Content Data:</strong> Books, artwork, voice
                  recordings, and lore entries you create
                </li>
                <li>
          ...
          <section>
            ...
            <div className="text-gray-300 space-y-4">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>
                  <strong>OpenAI:</strong> For GPT-4o text generation in
                  Ghostscribe
                </li>
                <li>
                  <strong>Mistral AI:</strong> For alternative text generation
                </li>
                <li>
                  <strong>Replicate:</strong> For SDXL image generation in Vault
                  Engine
                </li>
                <li>
                  <strong>ElevenLabs:</strong> For voice synthesis in Narrata
                </li>
                <li>
              ...
              <p>
                Each service has its own privacy policy, and we ensure they meet
          ...
          <section>
            ...
            <div className="text-gray-300 space-y-4">
              ...
              <p>
                ...
                <a
                  href="mailto:privacy@mystronium.com"
                  className="text-blue-400 hover:underline"
                >
                  privacy@mystronium.com
                </a>
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="text-gray-300 space-y-4">
              <p>
                <strong>You retain full ownership</strong> of all content you
                create using MYSTRONIUM tools:
              </p>
              <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <p>
                We only store your content to provide the service and never
                claim ownership or use it for other purposes.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="text-gray-300 space-y-4">
              ...
              <div className="bg-gray-700/50 p-4 rounded-lg">
                ...
                <p>
                  <strong>Address:</strong> MYSTRONIUM™ Platform, Digital
                  Creative Services
                </p>
              </div>
            </div>
