    ...
    try {
      ...
      setTimeout(async () => {
        try {
          ...
          toast.success(
            `🎉 Successfully purchased ${totalCredits} Vault Credits!`,
          );
          setLoading(null);
        } catch (error) {
          console.error("Error updating credits:", error);
          toast.error(
            "Purchase successful but failed to update credits. Please contact support.",
          );
          setLoading(null);
        }
      }, 2000);
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 text-lg">
              Power up your creativity • Generate unlimited art
            </p>
            {userProfile && (
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <p className="text-gray-400 text-sm">
                  1 credit = 1 high-quality AI image generation
                </p>
              </div>
          ...
          >
            ...
            <p className="text-gray-300 mb-6">
              Upgrade to Premium or Creator Pro for unlimited Vault Engine
              generations plus access to all premium features.
            </p>
