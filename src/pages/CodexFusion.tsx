...
const CodexFusion = () => {
  ...
  const performFusion = async () => {
    ...
    setTimeout(() => {
      ...
      const result =
        fusionResults[Math.floor(Math.random() * fusionResults.length)];
          ...
          >
            <div className="text-center mb-8">
              ...
              <p className="text-gray-400">
                Combine 3 Vault Cards to unlock powerful new items and abilities
              </p>
            </div>
              ...
              <div className="space-y-6">
                          ...
                          >
                            {selectedCards[index] ? (
                              <div
                                ...
                                onClick={() =>
                                  removeCard(selectedCards[index].id)
                                }
                              >
                                <div className="text-2xl">
                                  {getTypeIcon(selectedCards[index].type)}
                                </div>
                ...
                <div className="bg-red-900/20 border border-red-500/50 p-4 rounded-lg">
                  <p className="text-red-300 text-sm">
                    ⚠️ <strong>Warning:</strong> Fusion consumes the selected
                    cards permanently. Choose wisely!
                  </p>
                </div>
              </div>
            </div>
