  ...
  const tools = [
    {
      ...
      description:
        "Summon stories from the digital ether. Channel the power of GPT-4o to forge epic narratives.",
      lore: "The Ghostscribe whispers forgotten tales through quantum algorithms.",
      color: "from-purple-600 to-blue-600",
      hoverColor: "from-purple-700 to-blue-700",
      link: "/ghostscribe",
      preview:
        "Once upon a time, in a realm where code and creativity merged...",
    },
    {
      id: "vault",
      name: "Vault Engine™",
      ...
      description:
        "Transmute imagination into stunning visuals. Each creation becomes a collectible Vault Card.",
      lore: "The Vault holds infinite artistic possibilities, guarded by ancient glyphs.",
      color: "from-cyan-600 to-blue-600",
      hoverColor: "from-cyan-700 to-blue-700",
      link: "/vault",
      preview:
        "Generating mystical artwork with ethereal lighting and cosmic energy...",
    },
    {
      id: "narrata",
      name: "Narrata™",
      ...
      description:
        "Breathe life into your words. Transform text into captivating voice narrations.",
    ...
    },
    {
      ...
      description:
        "Weave the fabric of your creative universe. Track characters, events, and hidden connections.",
      lore: "The Codex remembers all—past, present, and futures yet unwritten.",
      color: "from-green-600 to-emerald-600",
      hoverColor: "from-green-700 to-emerald-700",
      link: "/codex",
      preview:
        "Character: The Archivist | Location: Digital Sanctum | Event: The Great Convergence",
    },
    {
      id: "archivist",
      name: "The Archivist™",
      ...
      description:
        "Trade rare Vault Cards with the mysterious Keeper of Secrets. Unlock hidden knowledge.",
      ...
      link: "/archivist",
      preview:
        '"Bring me three rare cards, and I shall reveal the secrets of creation..."',
    },
    {
      id: "bookstore",
      name: "The Bookstore™",
      ...
      description:
        "Discover and acquire legendary tomes crafted by fellow creators. Support the community.",
    ...
    },
    {
      ...
      description:
        "Transform your books into stunning visual comics. Panel by panel, scene by scene.",
      lore: "Where written words transcend into visual poetry, frame by frame.",
      color: "from-pink-600 to-purple-600",
      hoverColor: "from-pink-700 to-purple-700",
      link: "/comics",
      preview:
        "Panel 1: Hero discovers ancient artifact | Panel 2: Magic awakens...",
    },
  ];
      ...
      <div className="relative z-10">
        ...
        <section className="min-h-screen flex items-center justify-center px-6">
          <div className="text-center max-w-6xl mx-auto">
            ...
            >
              "Powered by the Vault Engine™ • Where imagination becomes
              reality"
            </motion.p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-gray-400">
                Summon your Glyphs • Decode forgotten lore • Transcend the
                ordinary
              </p>
            </motion.div>
          ...
          >
            <div className="bg-gradient-to-r from-purple-900/30 to-blue-900/30 backdrop-blur-sm p-12 rounded-xl border border-gold/30">
              ...
              <p className="text-xl text-gray-300 mb-8">
                Join thousands of creators who have already transcended the
                ordinary. Your imagination is the only limit in the MYSTRONIUM™
                universe.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400 text-sm mb-4">
                The ultimate AI-powered creative platform for writers, artists,
          ...
          <div className="border-t border-gray-700 mt-8 pt-8 text-center">
            <p className="text-gray-400 text-sm">
              Powered by the Vault Engine™ • Built for Creators • Forged in
              Digital Fire
            </p>
          </div>
        </div>
