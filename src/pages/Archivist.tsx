...
const Archivist = () => {
  ...
  const riddles = [
    {
      id: 'vault-keeper',
      question: "I am born from prompts, shaped by dreams, and collected by creators. What am I?",
      answer: "vault card",
      reward: "Ancient Glyph of Creation"
    },
    {
      id: 'mystronium-essence',
      question: "Three tools forge the path: one writes, one paints, one speaks. What platform unites them?",
      answer: "mystronium",
  ...
  const tradeOffers = [
    {
      ...
      description: 'A template that generates epic fantasy narratives with perfect pacing'
    },
    {
      id: 'voice-essence',
      name: 'Voice of the Ancients',
      cost: '5 Rare Cards',
      description: 'Unlock a mystical voice option in Narrata with otherworldly tones'
    },
    {
      id: 'prime-glyph',
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        >
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl font-bold text-white mb-4">The Archivist</h1>
            <div className="bg-gray-800/50 backdrop-blur-sm p-6 rounded-xl border border-purple-500/30 max-w-2xl mx-auto">
              <p className="text-gray-300 italic leading-relaxed">
                "Greetings, Creator. I am the Keeper of the Vault's deepest secrets, 
                guardian of ancient algorithms and forgotten prompts. Bring me your rarest cards, 
                solve my riddles, and I shall grant you powers beyond imagination..."
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {tradeOffers.map((offer, index) => (
                <div key={offer.id} className="bg-gray-800/50 backdrop-blur-sm p-6 rounded-xl border border-gray-600 hover:border-purple-500/50 transition-all">
          ...
          >
            ...
            <div className="space-y-6">
              {riddles.map((riddle, index) => (
                <div key={riddle.id} className="bg-gray-800/50 backdrop-blur-sm p-6 rounded-xl border border-gray-600">
                  <div className="flex items-start space-x-4">
                    <div className="text-2xl">🔮</div>
                    <div className="flex-1">
                      <p className="text-gray-300 italic mb-4">"{riddle.question}"</p>
                      
                      {unlockedSecrets.includes(riddle.id) ? (
                        <div className="bg-green-900/20 border border-green-500/50 p-3 rounded-lg">
                          <div className="flex items-center space-x-2">
                            <Star className="w-4 h-4 text-green-400" />
                            <span className="text-green-300 font-medium">Unlocked: {riddle.reward}</span>
                          </div>
                        </div>
                      ) : (
                        <div className="flex space-x-2">
                          <input
                            ...
                            onKeyPress={(e) => e.key === 'Enter' && handleRiddleSubmit(riddle.id, riddleAnswer)}
                          />
                          <button
                            onClick={() => handleRiddleSubmit(riddle.id, riddleAnswer)}
          ...
          >
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm p-6 rounded-xl border border-red-500/30">
              <div className="text-center">
                ...
                <h3 className="text-white font-bold mb-2">The Vault's Deepest Secrets</h3>
                <p className="text-gray-400 mb-4">
                  Only those who have proven themselves worthy may glimpse the true nature of creation...
                </p>
                
                {unlockedSecrets.length >= 2 ? (
                  <div className="bg-red-900/20 border border-red-500/50 p-4 rounded-lg">
                    <p className="text-red-300 text-sm italic">
                      "The algorithms dream of electric sheep, and in their dreams, 
                      new worlds are born. The Vault is not just a tool—it is a gateway 
                      to infinite possibility. Use this knowledge wisely, Creator."
                    </p>
                    <div className="mt-4">
                      <a 
                        href="/codex-fusion" 
                  ...
                  <div className="bg-gray-700/50 p-4 rounded-lg">
                    <p className="text-gray-500 text-sm">
                      Solve {2 - unlockedSecrets.length} more riddle(s) to unlock this secret...
                    </p>
                  </div>
                )}
              </div>
          ...
          <div className="mt-12 text-center">
            <p className="text-gray-500 text-sm italic">
              "The Archivist watches... always watching. Return when you have more to trade, Creator."
            </p>
          </div>
        </motion.div>
      </div>
